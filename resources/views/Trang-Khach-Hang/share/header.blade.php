        ...
        <div class="container clearfix" id="site-header-inner">
            <div id="logo" class="logo float-left">
                <a href="index.html" title="logo">
                    <img src="/assets_client/images/logo.png" alt="image" width="107" height="24" data-retina="/assets_client/images/logo@2x.png" data-width="107" data-height="24">
                </a>
            </div><!-- /.logo -->
                    ...
                    <ul class="menu">
                        <li class="active">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="active"><a href="index-v9.html">Homepage Style 9</a></li>
