							...
							<ul class="main-menu list-unstyled">
								<li class="menu-list-item nav-item has-dropdown" style=" padding: 0 !important;">
									<div class="mega-menu-header">
										<a class="nav-link p-0" href="/"><i class="fa-regular fa-user " style="font-size: 23px; "></i></a>
									</div>
								...
								<div class="submenu-transform submenu-transform-desktop">
									<div class="container">
										<ul class="submenu megamenu-container list-unstyled">
											...
											<li class="menu-list-item nav-item-sub">
												<div class="mega-menu-header">
													<a class="nav-link-sub nav-text-sub megamenu-heading" href="/san-pham/{{$danhmuc->ten_danh_muc_slug}}">
												...
												<div class="submenu-transform megamenu-transform">
													...
													@foreach($theLoai as $theloai)  
														@if($theloai->ma_danh_muc == $danhmuc->id)
															<li class="menu-list-item nav-item-sub">
																<a class="nav-link-sub nav-text-sub" href="/san-pham/{{$danhmuc->ten_danh_muc_slug}}/{{ $theloai->ten_loai_slug }}">{{ $theloai->ten_loai }}</a>
															</li>
														@endif
													@endforeach
													</ul>
