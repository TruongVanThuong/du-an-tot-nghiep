                        ...
                        <div class="product-details ps-lg-4">
                            ...
                            <form class="product-form" action="#">
                                <div
                                    ...
                                    <button type="submit"
                                        class="position-relative btn-atc btn-add-to-cart loader">ADD TO CART</button>
            ...
            <div class="modal-body px-4">
                <form action="#" class="newletter-modal-form common-form mx-auto">
                    <div class="section-header mb-3">
                        ...
                        <hr>
                        <p class="newsletter-modal-misc text_14 mt-4 text-center">Sign up & be the first to hear about
                            exclusive offers, new arrivals & more.</p>
                    </div>
