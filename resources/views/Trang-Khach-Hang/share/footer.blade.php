                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                        <div class="footer-widget-inner">
                            ...
                            <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                <li class="footer-menu-item"><a href="/">Trang Chủ</a></li>
                                <li class="footer-menu-item"><a href="/san-pham">Cửa Hàng</a></li>
                                <li class="footer-menu-item"><a href="/tin-tuc">Tin Tức </a></li>
                                <li class="footer-menu-item"><a href="/lien-he">Liên Hệ</a></li>
                                <li class="footer-menu-item"><a href="/gioi-thieu">Giới Thiệu</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                    ...
                                    @foreach ($danhMuc as $danhmuc)
                                        @if ($danhmuc->is_delete == 0)
                                            <li class="footer-menu-item"><a
                                                    href="/san-pham/{{ $danhmuc->ten_danh_muc_slug }}">{{ $danhmuc->ten_danh_muc }}</a>
                                            </li>
                                        @endif
                                    @endforeach
                                @else
