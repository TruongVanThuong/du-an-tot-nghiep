...
@section('noi-dung')
<main id="MainContent" class="content-for-layout"> <div class="collection mt-100" style="margin-bottom: 100px;"> <div
    class="container">
    ...
    <div class="col-lg-9 col-md-12 col-12">
        ...
        <h2 class="collection-title heading_24 mb-0">
            Sản Phẩm {{$data_danh_muc->ten_danh_muc}} -
    ...
    <div class="product-card">
        ...
        href="/san-pham/{{$data_danh_muc->ten_danh_muc_slug}}/{{$the_loai->ten_loai_slug}}/{{$san_pham->ten_san_pham_slug}}">
        ...
        <div class="product-card-action product-card-action-2 justify-content-center"> <a href="#quickview-modal"
            ...
            <path d="M10 0C15.5117 0 20 4.48828 20 10C20 12.3945 19.1602 14.5898 17.75 16.3125L25.7188 24.2812L24.2812
                25.7188L16.3125 17.75C14.5898 19.1602 12.3945 20 10 20C4.48828 20 0 15.5117 0 10C0 4.48828 4.48828 0 10
                0ZM10 2C5.57031 2 2 5.57031 2 10C2 14.4297 5.57031 18 10 18C14.4297 18 18 14.4297 18 10C18 5.57031
                14.4297 2 10 2ZM11 6V9H14V11H11V14H9V11H6V9H9V6H11Z" fill="#00234D" /> </svg>
                </a>
