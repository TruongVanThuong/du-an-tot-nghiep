                ...
                <div class="row flex-row-reverse">
                    ...
                    <div class="col-lg-9 col-md-12 col-12">
                        ...
                        <div class="collection-product-container">
                            <div class="row">
                                @if (count($san_pham_the_loai) > 0)
                                    @foreach ($san_pham_the_loai as $key => $value)
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="product-card-details">
                                                    ...
                                                    <div class="product-card-price">
                                                        ...
                                                        <span
                                                            class="card-price-compare text-decoration-line-through">{{ number_format($value->giam_gia_san_pham) }} ₫</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
