                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        </strong>đã đến với website của chúng tôi.<br>Để
                                                                        thực hiện việc đổi mật khẩu tài khoản vui lòng
                                                                        bấm vào liên kết dưới đây.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="{{ env('APP_URL') }}/kich-hoat-mail-doi-mat-khau/{{ $du_lieu['ma_bam_quen_mat_khau'] }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">{{ env('APP_URL') }}/kich-hoat-mail-doi-mat-khau/{{ $du_lieu['ma_bam_quen_mat_khau'] }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
