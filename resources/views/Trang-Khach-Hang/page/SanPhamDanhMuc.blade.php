                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        ...
                                        <div class="product-card-action product-card-action-2 justify-content-center">
                                            <a href="/san-pham/{{ $value->ten_danh_muc_slug }}/{{ $value->ten_loai_slug }}/{{ $value->ten_san_pham_slug }}{{$value->id}}" class="action-card action-quickview" data-bs-toggle="modal">
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <div class="product-card-price">
                                            <span class="card-price-regular">{{ number_format($value->gia_san_pham) }}
                                                ₫</span>
                                            <span class="card-price-compare text-decoration-line-through">{{ number_format($value->giam_gia_san_pham) }}
                                                ₫</span>
                                        </div>
                                    </div>
                                </div>
