                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <div class="product-card-price">
                                            <span class="card-price-regular">{{ number_format($value->gia_san_pham * (1
                                                - $value->giam_gia_san_pham / 100) ) }} ₫</span>
                                            <span class="card-price-compare text-decoration-line-through">{{
                                                number_format($value->gia_san_pham) }} ₫</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
