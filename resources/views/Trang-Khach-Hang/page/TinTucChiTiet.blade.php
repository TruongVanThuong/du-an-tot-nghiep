                                        ...
                                        <div class="comments-main-content">
                                            <div class="comments-meta">
                                                ...
                                                <div class="comments-date article-date d-flex align-items-center">
                                                    ...
                                                    <span class="ms-2">@{{ value ? value.created_at : 'Không có ngày đăng' }}</span>
                                                </div>
                                ...
                                <div class="form-header">
                                    ...
                                    <div class="name-email-field d-flex justify-content-between">
                                        ...
                                        <div class="field-item email-field">
                                            ...
                                            <input v-model="them_binhluan.ma_bai_viet"  type="hidden">  
                                        </div>
                                    </div>
                                        ...
                                        <textarea v-model="them_binhluan.noi_dung" cols="20" rows="6" placeholder="Write your comment here........"></textarea>
                                    </div>
        ...
        methods: {
            ...
            laybinhluan() {
                axios
                    .get('/lay-binh-luan')
                    .then((res) => {
                        this.ds_binhluan = res.data.data_binhluan_baiviet;
            ...
            them_binh_luan() {
                ...
                axios
                    .post('/them-binhluan-tintuc', this.them_binhluan)
                    .then((res) => {
                        if (res.data.status) {
