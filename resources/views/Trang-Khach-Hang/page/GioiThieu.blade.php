                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="about-hero-content">
                                <h2 class="about-hero-title">We Provide Expert Service and aim to have a long term with you
                                </h2>
                                <p class="about-hero-subtitle">We provide a full range of front end mechanical repairs for
                                    all makes and models of cars, no matter</p>
                                <ul class="about-hero-action p-0">
                                    <li class="action-item d-flex">
                                        ...
                                        <div class="action-content">
                                            ...
                                            <p class="action-subtitle">Through True Rich Attended does no end it his mother
                                                since real had half every.</p>
                                        </div>
                                    </li>
                                    <li class="action-item d-flex">
                                    ...
                                    <li class="action-item d-flex">
                                        ...
                                        <div class="action-content">
                                            ...
                                            <p class="action-subtitle">Ecstatic unsatiable saw his giving Remain expense you
                                                position concluded.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="about-hero-img">
                                <img src="/assets_client/img/about/about-hero.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-0 justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="300">
                        <div class="promotional-item overlay-blue">
                            <img src="/assets_client/img/about/p1.jpg" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                                    ...
                                    <p class="promo-subtitle">We provide a full range of front end mechanical repairs for
                                        all makes and models of cars, no matter the cause. This includes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="700">
                        <div class="promotional-item overlay-black">
                            <img src="/assets_client/img/about/p2.jpg" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                                    <h2 class="promo-title">To be the world’s most eader in automotive business solutions.
                                    </h2>
                                    <p class="promo-subtitle">We provide a full range of front end mechanical repairs for
                                        all makes and models of cars, no matter the cause. This includes</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-duration="1000">
                        <div class="promotional-item overlay-yellow">
                            <img src="/assets_client/img/about/p3.jpg" alt="img">
                            <div class="promotional-absolute">
                                <div class="promotional-content text-center">
                                    <h2 class="promo-title">We value the service we provide and our loyal returning
                                        customers </h2>
                                    <p class="promo-subtitle">We provide a full range of front end mechanical repairs for
                                        all makes and models of cars, no matter the cause. This includes</p>
                                </div>
