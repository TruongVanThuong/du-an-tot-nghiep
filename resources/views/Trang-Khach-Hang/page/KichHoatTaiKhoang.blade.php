                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Chào mừng bạn, <strong>{{ $du_lieu['ho_va_ten'] }}
                                                                        </strong>đã đến với website của chúng tôi. Chúng
                                                                        tôi vui mừng khi bạn đã đăng ký tài khoản.<br>Để
                                                                        thực hiện việc kích hoạt tài khoản vui lòng bấm
                                                                        vào liên kết dưới đây.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:1px;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                            href="{{ env('APP_URL') }}/kich-hoat-tai-khoang/{{ $du_lieu['ma_bam_email'] }}"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="{{ env('APP_URL') }}/kich-hoat-tai-khoang/{{ $du_lieu['ma_bam_email'] }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">{{ env('APP_URL') }}/active/{{ $du_lieu['ma_bam_email'] }}</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
