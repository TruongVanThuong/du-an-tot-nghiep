                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Cảm ơn bạn,
                                                                        <strong>{{ $du_lieu['ho_va_ten'] }}</strong> đã
                                                                        đặt hàng tại website của chúng tôi.Chúng tôi
                                                                        rất vui mừng và sẵn sàng hỗ trợ nếu có bất kỳ
                                                                        điều gì. Hy vọng bạn sẽ thích sản phẩm và quay
                                                                        lại mua sắm tại website của chúng tôi trong
                                                                        tương lai. Trân trọng!<br>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <table class="table table-bordered" style="border: 1px solid #000;">
                                                                <thead style="background: #ffae00">
                                                                    <tr>
                                                                        <th class="text-center" style="border: 1px solid #000;">Mã sản phẩm</th>
                                                                        <th class="text-center" style="border: 1px solid #000;">Mã hóa đơn</th>
                                                                        <th class="text-center" style="border: 1px solid #000;">Tên sản phẩm</th> 
                                                                        <th class="text-center" style="border: 1px solid #000;">Giá sản phẩm</th>
                                                                        <th class="text-center" style="border: 1px solid #000;">Ngày đặt sản phẩm</th>
                                                                        <th class="text-center" style="border: 1px solid #000;">Tổng số lượng</th>
                                                                        <th class="text-center" style="border: 1px solid #000;">Tổng tiền</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    @foreach ($du_lieu['hoa_don_chi_tiet'] as $key => $value)
                                                                        <tr>
                                                                            <th class="align-middle text-center" style="border: 1px solid #000;">{{ $value->id }}</th>
                                                                            <th class="align-middle text-center" style="border: 1px solid #000;">{{ $value->ma_hoa_don }}</th>
                                                                            ...
                                                                            <th class="align-middle text-center" style="border: 1px solid #000;">{{  number_format($value->tong_tien) }} ₫</th>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                                <tfoot>
                                                                    <tr>
                                                                        <th class="align-middle text-center" colspan="7" >
                                                                            Tổng tiền bao gồm cả thuế và phí ship : {{ number_format($du_lieu['hoa_don_moi']->tong_tien_tat_ca) }} ₫
                                                                        </th>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Nếu bạn muốn xem chi tiết hơn về đơn hàng của mình, hãy nhấp vào liên kết dưới đây để truy cập trang web của chúng tôi:</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                    <a target="_blank"
                                                                        href="{{ env('APP_URL') }}/khach-hang/lich-su-mua-hang"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">{{ env('APP_URL') }}/khach-hang/lich-su-mua-hang</a>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <em><strong>vxnguyen311@gmail.com</strong></em><br><em>Đây
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Chúng tôi mong muốn bạn có trải nghiệm tuyệt vời
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
