                ...
                <div class="container">
                    <div class="contact-form-area">
                        <div class="section-header mb-4">
                            <h2 class="section-heading">Đóng Góp Ý Kiến & Hổ Trợ</h2>
                            <p class="section-subheading">Chúng Tôi Luôn Sẳn Sàng Lắng nghe Ý Kiến & Hổ Trợ Của Bạn</p>
                        </div>
    ...
    <script>
        new Vue({
            ...
            watch: {
                ...
                'lien_he.tieu_de': function(newVal) {
                    if (newVal) {
                        this.errors.tieu_de = '';
                    }
                },
