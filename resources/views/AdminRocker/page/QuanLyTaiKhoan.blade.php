          ...
          <table id="table" class="table table-bordered">
            ...
            <tbody>
              <tr v-for="(taikhoan, key) in data_taikhoan">
                ...
                <td class="align-middle text-center">@{{ getTenPhanQuyen(taikhoan.loai_tai_khoan) }}</td>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group mt-3">
                      ...
                      <select v-model="add_user.loai_tai_khoan" class="form-control">
                        <option v-for="(phanquyen, key) in data_phanquyen" :value="phanquyen.role_phan_quyen">
